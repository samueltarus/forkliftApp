...
Route::get('/checkout', [App\Http\Controllers\MpesaController::class, 'checkout'])->name('checkout');
Route::post('/handleCallback', [App\Http\Controllers\MpesaController::class, 'handleCallback'])->name('handleCallback');
